...
if (isset($_POST['add_product'])) {
   ...
   if ($select_products->rowCount() > 0) {
      ...
      $insert_products = $conn->prepare("INSERT INTO `products`(farmer_id,name,farmer_email, category, details, price, image) VALUES(?,?,?,?,?,?,?)");
      $insert_products->execute([$farmer_id,$name,$farmer_email, $category, $details, $price, $image]);
      ...
      <form action="" method="POST" enctype="multipart/form-data">
         <div class="flex">
            <div class="inputBox">
               ...
               <input type="number" min="0" name="price" class="box" required placeholder="enter product price /kg">
               <select name="category" class="box" required>
                  ...
                  <option value="grains_crops">grains and other crops</option>
               </select>
            </div>
            <div class="inputBox">
               
               <input type="email" name="farmer_email" class="box" placeholder="enter your email" required>
      ...
      <div class="box-container">
         ...
         if ($show_products->rowCount() > 0) {
            while ($fetch_products = $show_products->fetch(PDO::FETCH_ASSOC)) {
               ...
               <div class="box">
                  <div class="price">
                     ₹<?= $fetch_products['price']; ?>/kg
                  </div>
                  <img src="uploaded_img/<?= $fetch_products['image']; ?>" alt="">
                  <div class="name">
                    <b> <?= $fetch_products['name']; ?></b>
                  </div>
      
                  <!-- <div class="name">
                     <?= $fetch_products['farmer_email']; ?>
                  </div>
                  <div class="cat">
